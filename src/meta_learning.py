...
def reptile(model, datasets, total_epochs = 750, batch_sz = 16, inner_steps = 20, epsilon = 1, save_weights=False, task="erp"):
  ...
  if save_weights:
    model.save_weights("./models/{0}_meta_init.h5".format(task))
